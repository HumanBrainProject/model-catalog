                                ...
                                {model_versions.map(function (
                                    ...
                                    return (
                                        <ResultPerInstanceComboMT
                                            ...
                                            key={
                                                model_version_entry.model_inst_id
                                            }
                                        />
                                    );
                                })}
    ...
    groupResults = (list_model_versions, results) => {
        ...
        results.forEach(function (result, index) {
            ...
            if (
                ...
                dict_results[result.test_id]["test_instances"][
                    result.test_instance_id
                ]["results"][result.model_instance_id] = [];
            }
            // add result to list of model instance results for above test instance
            dict_results[result.test_id]["test_instances"][
                result.test_instance_id
            ]["results"][result.model_instance_id].push({
                result_id: result.id,
                score: result.score,
            ...
            Object.keys(dict_results[test_id]["test_instances"]).forEach(
                function (test_inst_id) {
                    Object.keys(
                        ...
                        dict_results[test_id]["test_instances"][test_inst_id][
                            "results"
                        ][model_inst_id].sort(function (a, b) {
                            if (a.timestamp < b.timestamp) {
                                return 1;
                            }
                            if (a.timestamp > b.timestamp) {
